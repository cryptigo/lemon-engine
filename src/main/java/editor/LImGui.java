...
public class LImGui {
    ...
    public static void drawVec2Control(String label, Vector2f values, float resetVal) {
        drawVec2Control(label, values, resetVal, defaultColumnWidth);
    }
    ...
    public static void drawVec2Control(String label, Vector2f values, float resetVal, float columnWidth) {
        ImGui.pushID(label);
